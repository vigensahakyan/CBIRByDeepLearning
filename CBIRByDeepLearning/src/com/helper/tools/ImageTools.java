...
public class ImageTools {
	...
	//public static BufferedImage ResizeImage(int newWidth, int newHeight, String pathToImage, int saveImage ){
	...
	public static void GenerateImageFromPixelArray(int imgWidth,int imgHeight, int [] pixelArray, String pathToSaveImage) throws IOException{
		BufferedImage grayscaleImage = new BufferedImage(imgWidth,
				imgHeight, BufferedImage.TYPE_INT_RGB);
	...
	// Generate gray scale images to outDir from CSV file with row Images in every row
	public static void GenerateImageFromCSVDataSet(int imgWidth,int imgHeight, String csvPath, String outDir) throws IOException{
...
//		
//		//IT.ReadImageConvertToGrayScale("C:\\Users\\V.Sahakyan\\Pictures\\imgTest.jpg");
//		//IT.NormalizeIntArray(IT.ReadImageConvertToGrayScale(IT.ResizeImage(20, 20, "C:\\Users\\V.Sahakyan\\Pictures\\imgTest.jpg", 0)));
//		//IT.ResizeImage(120, 100, "C:\\Users\\V.Sahakyan\\Pictures\\imgTest.jpg", 1);
//		IT.GenerateImageFromCSVDataSet(28, 28, "C:/Users/V.Sahakyan/Documents/R-Workspace/featureResult.csv", "C:\\Users\\V.Sahakyan\\Pictures\\feature\\");

...
public class TestNN {
	...
	public void Run(String path) throws IOException {
		...
		try {
			...
			File file = new File("path/to/neuralnet.ser");
			file.createNewFile();
	...
	public void RestoreFromDump(String path) throws IOException {
		try {
			FileInputStream fileIn = new FileInputStream("path/to/neuralnet.ser");
	...
	public static void main(String[] args) throws IOException {
		TestNN tnn = new TestNN("path/to/mnistTestencode.csv");
		// tnn.Run("path/to/mnistencode.csv");

...
public class ImagePredictionService {
	...
	public String predictImageAndReturnClassValue(@FormDataParam("my_file") InputStream fileInputStream,
			@FormDataParam("my_file") FormDataContentDisposition fileFormDataContentDisposition) throws IOException {
		// local variables
		...
		try {
			...
			// "C:\\Users\\V.Sahakyan\\Documents\\"+fileName;
		...
		// return "<html>"+"<titles"+"University Information"+"</titles>"+
		// "<body><h1>" + classID +"</h1></body>"+"</html>";
	}
	...
	public String predictionServerCheker() {
		...
		return "<html>" + "<titles" + "University Information" + "</titles>" + "<body><h1>"
				+ "Your prediction server is Up and Run. Please initialize your NeuralNetwork and AutoEncoder models."
				+ "</h1></body>" + "</html>";
	}
